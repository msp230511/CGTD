...
TodoEntry.create!(name: 'Write Tests', description: 'We should write tests first', priority: 2, category: 'Work',
                  due_at: Time.now.advance(days: 1).to_s, completed: false, todo_list_id: list2.id)
TodoEntry.create!(name: 'Write User Stories', description: "Mom said if I don't do it she will be really mad", priority: 1,
                  category: 'Work', due_at: Time.now.advance(hours: 1).to_s, completed: false, todo_list_id: list2.id)
TodoEntry.create!(name: 'Change Datastructures', description: 'Introduce Many to Many Relationhips for Users and TodoLists', priority: 2, category: 'Work',
                  due_at: Time.now.advance(days: 5).to_s, completed: false, todo_list_id: list2.id)
TodoEntry.create!(name: 'Learn how to do a Backflip',
                  description: 'Seriously: https://www.youtube.com/watch?v=ltho8_PzC2U', priority: 1, category: 'Work', 
...
TodoEntry.create!(name: 'Meditate for 20 minutes', description: 'Gotta do it', priority: 1, category: 'Work',
